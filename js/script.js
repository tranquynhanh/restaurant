...
(function(global){
    ...
    var showLoading = function(selector){
        ...
        html += "<img src='image/spinner.svg'><div>";
    ...
    document.addEventListener("DOMContentLoaded", function(event){
        ...
        function buildMenuItemsViewHtml(categoryMenuItems,
                                        ...
                                        menuItemHtml){
            menuItemTitleHtml = 
                insertProperty(menuItemTitleHtml, "name", categoryMenuItems.category.name);
            menuItemTitleHtml =
                insertProperty(menuItemTitleHtml, 
            ...
            for (var i = 0; i < 2; i++){
                ...
                if (i % 2 != 0){
                    html += "<div class='clearfix d-none d-md-block d-lg-block d-xl-block'></div>";
                }
                finalHtml += html;
            }
            finalHtml += "</section>";
